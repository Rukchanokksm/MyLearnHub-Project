        ...
        {isLogin ? (
          <>
            <div className="flex gap-5 text-lg">
              <p className="p-1 text-yellow-400">Wellcome, {showUser.name}</p>
              <NavLink to="/">
                <button
                  onClick={logout}
          ...
          <div className="flex text-yellow-400 gap-5 text-lg">
            <NavLink to="/login" className="p-1 rounded-md border border-neutral-800 hover:border-yellow-400">
              Log in
            </NavLink>
            <NavLink to="/register">
              <button onClick={logout} className="p-1 rounded-md border border-neutral-800 hover:border-yellow-400">
                Register
              </button>
            </NavLink>
          </div>
